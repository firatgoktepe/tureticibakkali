        ...
        <div class="header-ftc header-<?php echo esc_attr($smof_data['ftc_header_layout']); ?>">
            <div class="header-content <?php echo esc_attr(implode(' ', $header_classes)); ?>">
                <div class="container">
                    ...
                    <?php if ($smof_data['ftc_bottom_header_content']): ?>
                        <div class="header_extra_content"><?php echo do_shortcode(stripslashes($smof_data['ftc_bottom_header_content'])); ?>
                        </div>
                    <?php endif; ?>
                    
                        
                    <?php if ($smof_data['ftc_enable_tiny_shopping_cart']): ?>
                            <div class="ftc-shop-cart mobile"><?php echo wp_kses_post(ftc_tiny_cart()); ?></div>
                        <?php endif; ?>
                    
                </div>
            </div>
            <div class="group-header19">
