...
$page_title = esc_html__( 'Store', 'organico' );
...
<div class="container">
            ...
            <div class="dokan-widget-area widget-collapse">
                ...
                if ( ! dynamic_sidebar( 'sidebar-store' ) ) {
                    ...
                    if ( class_exists( 'Dokan_Store_Location' ) ) {
                        the_widget( 'Dokan_Store_Category_Menu', array( 'title' => __( 'Store Category', 'organico' ) ), $args );

                        if ( dokan_get_option( 'store_map', 'dokan_general', 'on' ) == 'on'  && !empty( $map_location ) ) {
                            the_widget( 'Dokan_Store_Location', array( 'title' => __( 'Store Location', 'organico' ) ), $args );
                        }

                        if ( dokan_get_option( 'contact_seller', 'dokan_general', 'on' ) == 'on' ) {
                            the_widget( 'Dokan_Store_Contact_Form', array( 'title' => __( 'Contact Vendor', 'organico' ) ), $args );
                        }
                    }
    ...
    <div id="dokan-primary" class="dokan-single-store col-md-9 col-xs-12">
        <div id="dokan-content" class="store-page-wrap woocommerce" role="main">
            ...
            <p class="dokan-info"><?php _e( 'No products were found of this vendor!', 'organico' ); ?></p>
