					...
					<div class="entry-content">	
						...
						<div class="meta-content">
							...
							<div class="portfolio-info">
								<p><?php esc_html_e('Date:', 'organico') ?></p>
							...
							if ( $categories_list ):
								?>
								<div class="portfolio-info">
									<p><?php esc_html_e('Categories:', 'organico'); ?></p>
						...
						<div class="single-navigation">
							<?php
							previous_post_link('%link', esc_html__('Prev Project', 'organico'));
							next_post_link('%link', esc_html__('Next Project', 'organico'));
							?>
						</div>
					...
					<div class="col-md-6 col-sm-12">
						<div class="entry-content">	
							...
							<div class="meta-content">
								...
								<!-- Portfolio Date -->
								<div class="portfolio-info">
									<p class="ptsan"><?php esc_html_e('Date:', 'organico') ?></p>
									<span class="date-time"><?php echo get_the_time(get_option('date_format')); ?></span>
								</div>
								...
								if ( $categories_list ):
									?>
									<div class="portfolio-info">
										<p class="ptsan"><?php esc_html_e('Categories:', 'organico'); ?></p>
										<span class="cat-links"><?php print_r($categories_list); ?></span>
									</div>
								<?php endif; ?>
