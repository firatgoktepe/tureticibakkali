...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site">
     ...
     <header id="masthead" class="site-header">
        ...
        <div class="header-ftc header-layout16 header-<?php echo esc_attr($smof_data['ftc_header_layout']); ?>">
            ...
            <?php if ( has_nav_menu( 'primary' ) ) : ?>
                <div class="navigation-primary <?php echo esc_attr(implode(' ', $header_classes)); ?>">
                    <div class="container">
