...
class FTC_Product_Filter_By_Color{
	...
	function edit_color_attribute( $term, $taxonomy ){
		...
		?>
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Color', 'organico' ); ?></label></th>
			<td>
				...
				<span class="description"><?php esc_html_e('Use color picker to pick one color.','organico'); ?></span>
			</td>
		</tr>

		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Thumbnail Image', 'organico' ); ?></label></th>
			<td>
			...
			jQuery(document).ready(function(){
				...
				jQuery(document).on( 'click', '.ftc_color_upload_image_button', function( event ){
					...
					file_frame = wp.media.frames.downloadable_file = wp.media({
						title: '<?php esc_html_e( 'Choose an image', 'organico' ); ?>',
						button: {
							text: '<?php esc_html_e( 'Use image', 'organico' ); ?>',
						},
						multiple: false
					});
	...
	function add_color_attribute(){
		...
		<div class="form-field">
			<label><?php esc_html_e( 'Color', 'organico' ); ?></label>
		...
		<div class="form-field">
			<label><?php esc_html_e( 'Thumbnail Image', 'organico' ); ?></label>
