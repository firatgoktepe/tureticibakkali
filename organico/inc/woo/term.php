...
class Ftc_Custom_Product_Category{
	...
	function add_category_fields(){
		...
		<div class="form-field ftc-product-cat-upload-field">
			<label><?php esc_html_e( 'Breadcrumbs Background Image', 'organico' ); ?></label>
			...
			<div class="button-wrapper">
				...
				<button type="button" class="button upload-button"><?php esc_html_e('Upload/Add image', 'organico') ?></button>
				<button type="button" class="button remove-button"><?php esc_html_e('Remove image', 'organico') ?></button>
			</div>
		</div>
		
		<div class="form-field">
			<label for="layout"><?php esc_html_e( 'Layout', 'organico' ); ?></label>
			<select name="layout" id="layout">
				<option value=""><?php esc_html_e('Default', 'organico') ?></option>
				<option value="0-1-0"><?php esc_html_e('Fullwidth', 'organico') ?></option>
				<option value="1-1-0"><?php esc_html_e('Left Sidebar', 'organico') ?></option>
				<option value="0-1-1"><?php esc_html_e('Right Sidebar', 'organico') ?></option>
				<option value="1-1-1"><?php esc_html_e('Left & Right Sidebar', 'organico') ?></option>
			</select>
		</div>
		
		<div class="form-field">
			<label for="left_sidebar"><?php esc_html_e( 'Left Sidebar', 'organico' ); ?></label>
		...
		<div class="form-field">
			<label for="right_sidebar"><?php esc_html_e( 'Right Sidebar', 'organico' ); ?></label>
		...
		<div class="form-field ftc-product-cat-upload-field">
			<label><?php esc_html_e( 'Banner', 'organico' ); ?></label>
			<div class="preview-image">
				<?php echo wc_placeholder_img( 'thumbnail' ); ?>
			</div>
			<div class="button-wrapper">
		...
		<div class="form-field ftc-product-cat-upload-field">
			<label><?php esc_html_e( 'Icon', 'organico' ); ?></label>
			<div class="preview-image">
				<?php echo wc_placeholder_img( 'thumbnail' ); ?>
			</div>
			<div class="button-wrapper">
		...
		<div class="form-field">
			<label><?php esc_html_e( 'Top border color', 'organico' ); ?></label>
	...
	function edit_category_fields( $term, $taxonomy ){
		...
		<tr class="form-field ftc-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Breadcrumbs Background Image', 'organico' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php 
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Layout', 'organico' ); ?></label></th>
			<td>
				<select name="layout" id="layout">
					<option value="" <?php selected($layout, ''); ?>><?php esc_html_e('Default', 'organico') ?></option>
					<option value="0-1-0" <?php selected($layout, '0-1-0'); ?>><?php esc_html_e('Fullwidth', 'organico') ?></option>
					<option value="1-1-0" <?php selected($layout, '1-1-0'); ?>><?php esc_html_e('Left Sidebar', 'organico') ?></option>
					<option value="0-1-1" <?php selected($layout, '0-1-1'); ?>><?php esc_html_e('Right Sidebar', 'organico') ?></option>
					<option value="1-1-1" <?php selected($layout, '1-1-1'); ?>><?php esc_html_e('Left & Right Sidebar', 'organico') ?></option>
				</select>
			</td>
		</tr>
		
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Left Sidebar', 'organico' ); ?></label></th>
			<td>
				<select name="left_sidebar" id="left_sidebar">
					<option value="" <?php selected($left_sidebar, ''); ?>><?php esc_html_e('Default', 'organico') ?></option>
					<?php foreach( $sidebar_options as $sidebar_id => $sidebar_name ): ?>
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Right Sidebar', 'organico' ); ?></label></th>
			<td>
				<select name="right_sidebar" id="right_sidebar">
					<option value="" <?php selected($right_sidebar, ''); ?>><?php esc_html_e('Default', 'organico') ?></option>
					<?php foreach( $sidebar_options as $sidebar_id => $sidebar_name ): ?>
		...
		<tr class="form-field ftc-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Banner', 'organico' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php
		...
		<tr class="form-field ftc-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Icon', 'organico' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Top border color', 'organico' ); ?></label></th>
