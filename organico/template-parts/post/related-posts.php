...
if( $related_posts->have_posts() ){
	...
	<div class="related-posts related <?php echo esc_attr($is_slider)?'loading':'' ?>">
		<header class="related-post-title">
			<h3 class="product_title"><span class="bg-heading"><span><?php esc_html_e('Related Posts', 'organico'); ?></span></span></h3>
		</header>
	   ...
	   <span class="space"> / </span>
						...
						<?php if(isset($smof_data['ftc_blog_details_author_box']) && $smof_data['ftc_blog_details_author_box'] ): ?>
							<span class="vcard author"><?php esc_html_e('Posted by: ', 'organico'); ?><?php the_author_posts_link(); ?></span>
						<?php endif; ?>
					...
					<?php if(isset($smof_data['ftc_blog_count_view']) && $smof_data['ftc_blog_count_view'] ): ?>
						...
						if ( ($categories_list && isset($smof_data['ftc_blog_categories']) && $smof_data['ftc_blog_categories']) || isset($smof_data['ftc_blog_details_author_box']) && $smof_data['ftc_blog_details_author_box'] ): 
							?>
				...
				<!-- Blog Author -->
				<!--<span class="author"><?php //esc_html_e('Post by ','organico') ?><?php //the_author_posts_link(); ?></span>-->

				<!-- Blog Read More -->
				<a href="<?php the_permalink(); ?>" class="button-readmore"><?php esc_html_e('Read More','organico') ?></a>
			</div>
		</article>
	<?php endwhile; ?>
</div>
