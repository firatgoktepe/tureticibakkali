	...
	<?php if( $post_format != 'quote' ): ?>
		...
		<div class="post-info">
			...
			<div class="entry-info">
				...
				<h4 class="text-blog"><?php esc_html_e('Trends', 'organico'); ?></h4>
					<h3 class="product_title entry-title">
						<a class="post-title product_title" href="<?php the_permalink() ; ?>"><?php the_title(); ?></a>
					<?php endif; ?>
					
					<?php if ( is_sticky() && is_home() && ! is_paged() ): {
						printf( '<span class="sticky-post">%s</span>', __( 'Featured', 'organico' ) );
					}?>
			...
			<?php if(isset($smof_data['ftc_blog_author']) && $smof_data['ftc_blog_author'] ): ?>
				<span class="vcard author"><?php esc_html_e('Post by: ', 'organico'); ?><?php the_author_posts_link(); ?></span>
			<?php endif; ?>

			<!-- Blog Categories -->
			<?php if ( $categories_list && isset($smof_data['ftc_blog_categories']) && $smof_data['ftc_blog_categories'] ): ?>
				<div class="caftc-link">
					<span><?php esc_html_e('Categories: ', 'organico'); ?></span>
			...
			<span class="tags-link">
				<span><?php esc_html_e('Tags: ','organico');?></span>
...
<div class="entry-summary">
	<div class="full-content"><p><?php 
                    $max_words = (int)$smof_data['ftc_blog_excerpt_max_words']?(int)$smof_data['ftc_blog_excerpt_max_words']:125;
                    $strip_tags = isset($smof_data['ftc_blog_excerpt_strip_tags']) && $smof_data['ftc_blog_excerpt_strip_tags']?true:false;
	...
	<?php if(isset($smof_data['ftc_blog_read_more']) && $smof_data['ftc_blog_read_more'] ): ?>
		<a class="button-readmore" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read More', 'organico'); ?></a>
	<?php endif; ?>
</div>
</div>
